...
public class URLFactory {
    ...
    public static double BREASTFEEDING_WATER = 700.0d;
    public static String DAILY_WATER = "daily_water";
    public static float DAILY_WATER_VALUE = 0.0f;
    public static String DATE_FORMAT = "dd-MM-yyyy";
    public static double DEACTIVE_FEMALE_WATER = 11.43d;
    public static double DEACTIVE_MALE_WATER = 14.29d;
    ...
    public static double FEMALE_WATER = 28.57d;
    ...
    public static double MALE_WATER = 35.71d;
    ...
    public static double PREGNANT_WATER = 700.0d;
    ...
    public static double WEATHER_CLOUDY = 0.85d;
    public static String WEATHER_CONSITIONS = "weather_conditions";
    public static double WEATHER_RAINY = 0.68d;
    public static double WEATHER_SNOW = 0.88d;
    public static double WEATHER_SUNNY = 1.0d;
